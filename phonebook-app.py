...
app.config['MYSQL_DATABASE_PASSWORD'] = 'xxxxxxxxx'
...
# Write a function named `init_todo_db` create phonebook table within success_phonebook db, if it doesn't exist

def init_phonebook_db():
    phonebook_table = """
    CREATE TABLE IF NOT EXISTS success_phonebook.phonebook(
